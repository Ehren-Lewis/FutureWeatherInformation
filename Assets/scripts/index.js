...
//                     const icon = i.weather.icon;
//                     const humidity = i.main.humidity
//                     const wind = i.wind.speed;

//                     console.log(date, temp, humidity, wind);

//                     const newForecast = $("<div class='col-2'></div>");
//                     const dayRow = $(`<div class='row'>${date}</div>`);
//                     // const iconRow = $("<div class='row'></div>");
//                     // iconRow.append($(`<img src="http://openweathermap.org/img/wn/${icon}.png">`));
//                     const tempRow = $( `<div class='row'>${temp}\u00B0F</div>`);
//                     const humidityRow = $(`<div class='row'>${humidity}%</div>`);
//                     const windRow = $(`<div class='row'>${wind}MPH</div>`);
